...
public class CollectionExercises {
    ...
    public String[] makeTopThreeArray(String[] fruits) {
        ...
        // Replace the line below with your implementation
        String[] topThreeFruit = new String[3];

        for(int i = 0; i < 3; i++){
            topThreeFruit[i] = fruits[i];
        }

        return topThreeFruit;
    }
    ...
    public ArrayList<String> makeListOfThreeFruits(String fruit1, String fruit2, String fruit3) {
        ...
        // Replace the line below with your implementation
        ArrayList<String> topThreeFruit = new ArrayList<>();
        topThreeFruit.add(fruit1);
        topThreeFruit.add(fruit2);
        topThreeFruit.add(fruit3);
